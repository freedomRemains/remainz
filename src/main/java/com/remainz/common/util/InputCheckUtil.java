...
public class InputCheckUtil {
	...
	public void checkDb(GenericParam input) {
		...
		if (db == null) {
			throw new BusinessRuleViolationException(Mu.msg("msg.common.noParam", "db"));
		}
	}
	...
	public void checkParam(GenericParam input, String key) {
		...
		if (value == null || value.length() == 0) {
			throw new BusinessRuleViolationException(Mu.msg("msg.common.noParam", key));
		}
	}
	...
	private void checkInput(GenericParam input) {
		if (input == null) {
			throw new BusinessRuleViolationException(Mu.msg("msg.common.noParam", "input"));
		}
	}
}
